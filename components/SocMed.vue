...
<template>
    <div :class="[isMobile?[mobi.init, isSocMedHidden?mobi.hide:mobi.show]:'absolute top-0 right-0 mt-24 mr-8 ' ]" >
        <div :class="[isMobile?'flex justify-evenly':['flex flex-col gap-5 transition-all duration-200']]">
            <button class="[&>a>svg>g>path]:dark:lg:hover:fill-[#0077B5]" aria-label="visit linked in website">
                <a href="https://www.linkedin.com/in/zulfidly/" target="_blank" aria-label="visit linked in website">
                    <svg name="linkedin" x="0px" y="0px" width="40px" height="40px" viewBox="0 0 40 40" enable-background="new 0 0 40 40" xml:space="preserve">
                        <g>
                            <path class="fill-[var(--linkedin)] transition duration-300" d="M19.962,39.997c-5.656,0-11.312-0.021-16.969,0.013c-1.501,0.008-2.771-1.037-2.976-2.457
            ...
            <button class="[&>a>img]:dark:lg:hover:grayscale-0 [&>a>img]:dark:lg:hover:invert-0" aria-label="visit instagram in website">
                <a href="https://www.instagram.com/fidlybass/" target="_blank" aria-label="visit instagram in website">
                    <img class="grayscale-0 dark:grayscale invert-0 dark:invert-[60%] w-[40px] h-[40px] transition-all duration-300" src="/images/insta40.png" alt="Instagram logo" />
                </a>
            </button>                    
        </div>
