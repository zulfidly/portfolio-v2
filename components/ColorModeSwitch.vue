...
<template>
    <div class="sm:hidden lg:block rounded-xl" :class="[loca]">
        <button class="relative rounded-[11px] block w-[40px] h-[22px] border border-[var(--color-border)] bg-[var(--color-background-mute)] transition lg:hover:border lg:hover:border-[var(--color-soft-oppo)]" type="button" role="switch" aria-label="Toggle dark mode" :aria-checked="[isDarkScoped?'true':'false']">
            <span class="shadow-color-mode-sw dark:translate-x-[18px] absolute top-[1px] left-[1px] w-[18px] h-[18px] rounded-[50%] bg-[var(--color-background)] transition duration-200">
                <span class="relative block rounded-[50%] w-[28px] h-[28px] overflow-hidden box-border">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="false" focusable="false" viewBox="0 0 24 24" class="absolute top-[3px] left-[3px] w-[12px] h-[12px] fill-[var(--color-text)] opacity-100 dark:opacity-0 transition-opacity">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="false" focusable="false" viewBox="0 0 24 24" class="absolute top-[3px] left-[3px] w-[12px] h-[12px] fill-[var(--color-text)] opacity-0 dark:opacity-100 transition-opacity">
